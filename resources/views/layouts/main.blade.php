        ...
        <section id="page-profile" class="page-profile">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        {!! html_entity_decode(data_get($page, 'intro_paragraph', '')) !!}
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-md-6">
                            <article class="education">
                                <header>
                                    ...
                                    <p> {{ $education->credential }} - <strong>Graduated: </strong>{{ $education->year }}</p>
                                </header>
