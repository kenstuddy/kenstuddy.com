            ...
            this.$validator.validateAll().then(function (valid) {
                if (valid) {
                    ...
                    axios.post("/api/contact/send", data).then(function (response) {
                        ...
                        _this.successful = response.data.message;
                        ...
                        _this.unsuccessful = "An error has occurred: " + error.message;
          ...
          [
            ...
            _vm.successful
              ? _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("span", [_vm._v(_vm._s(_vm.successful))])
                  ]
                )
              : _vm._e(),
            _vm._v(" "),
            _vm.unsuccessful
              ? _c(
                  "div",
                  {
                    staticClass: "control-group alert alert-danger",
                    attrs: { name: "alert", id: "alert" }
                  },
                  [
                    _c(
                    ...
                    _vm._v(" "),
                    _c("span", [_vm._v(_vm._s(_vm.unsuccessful))])
                  ]
                )
              : _vm._e(),
            _vm._v(" "),
